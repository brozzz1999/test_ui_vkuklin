import pytest
from tests.data.user_data import bad_email_numbers
from tests.data.user_data import bad_email_long_text
from tests.data.user_data import bad_email_not_point
from tests.data.user_data import bad_email_not_domain
from tests.data.user_data import bad_email_not_dog

from tests.data.user_data import first_name
from tests.data.user_data import last_name
from tests.data.user_data import email_address
from tests.data.user_data import passwd
from tests.data.user_data import confirm_passwd
